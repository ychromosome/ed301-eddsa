...
- the OpenSSL context contract inside the sealed provider matrix.
...
The standalone gate does not accept an OpenSSL prefix or module directory.
The provider matrix supplies its verified lane and prebuilt harness directly.
