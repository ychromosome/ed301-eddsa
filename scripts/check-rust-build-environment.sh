...
ALLOWED='^(ED301_HERMETIC_LAUNCH|ED301_SOURCE_MODE|ED301_VERIFIED_SNAPSHOT|ED301_EXPECTED_SOURCE_MANIFEST_SHA256|ED301_EXPECTED_GIT_COMMIT|ED301_MODULE_DIR|ED301_PROVIDER_CONTEXT_HARNESS|OPENSSL_PREFIX|OPENSSL_OBJECT_LISTS|PATH|HOME|LC_ALL|PWD|SHLVL|_)='
