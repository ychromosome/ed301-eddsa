...
test ! -e /etc/crypto-policies/local.d/opensslcnf-zz-ed301.config
...
test -f /etc/crypto-policies/local.d/opensslcnf-zz-ed301.config
...
printf '%s\n' \
    'ed301_rpm_install=PASS base=explicit policy=active reinstall=clean remove=clean'
