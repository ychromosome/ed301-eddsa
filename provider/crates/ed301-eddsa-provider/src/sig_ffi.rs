...
pub(crate) struct SignatureRustApi {
    ...
    pub(crate) key_generate: extern "C" fn() -> *mut c_void,
...
/// allocating callbacks (`key_new`, `key_generate`, `key_duplicate`,
...
/// Generate a seed with the operating-system CSPRNG and derive its public key.
pub(crate) extern "C" fn key_generate() -> *mut c_void {
    ffi_pointer(|| {
